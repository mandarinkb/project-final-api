...
public class RestApiController {
  ...
  public ResponseEntity<?> createAuthenticationToken(@RequestBody UserDto userDto) throws Exception {
      ...
      this.usernameFromLogin = userDto.getUsername();
      log.createLog(dateTime.timestamp(), userDto.getUsername(), "login", "Login");  // เก็บ log
      return new ResponseEntity<>(response, HttpStatus.OK);
  }
  @GetMapping(path = {"/logout"}, headers = "Accept=application/json;charset=UTF-8")
  public ResponseEntity<?> logOut() {
	  JSONObject json = new JSONObject();
	  json.put("message", "logout");
	  
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "logout", "Logout");  // เก็บ log
  ...
  public ResponseEntity<?> createUsers(@RequestBody UserDto userDto)  throws Exception{ //
      ...
      if (userDb.equals("")) {
    	  ...
    	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "create", "create username "+userDto.getUsername());  // เก็บ log
      	...
      	log.createLog(dateTime.timestamp(), this.usernameFromLogin, "error", "That username is already taken. Try using a different name.");  // เก็บ log
  ...
  public ResponseEntity<?> readUsers() {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read users");  // เก็บ log
  ...
  public ResponseEntity<?> readUserId(@PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read from id (for role user)");  // เก็บ log
...
//get for role admin
  ...
  public ResponseEntity<?> readUsersById(@PathVariable("id") int id) {
	  ...
	  if(error.isFindUsersByIdError(serviceValue)) {
	      ...
	      log.createLog(dateTime.timestamp(), this.usernameFromLogin, "error", "Not found users");  // เก็บ log
          return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
	  }else {
		  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read from id (for role admin)");  // เก็บ log
  ...
  public ResponseEntity<?> updateUsers(@RequestBody UserDto userDto, @PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "update", "update username "+userDto.getUsername()+" role "+userDto.getRole()+" or chanege new password");  // เก็บ log
  ...
  public ResponseEntity<?> deleteUsers(@PathVariable("id") int id){
	  ...
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "delete", "delete username"+userDb);  // เก็บ log
  ...
  public ResponseEntity<?> createWeb(@RequestBody WebDto web) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "create", "create web "+web.getWebName());  // เก็บ log
  ...
  public ResponseEntity<?> findWeb() {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read web");  // เก็บ log
  ...
  public ResponseEntity<?> findWebId(@PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read web from id");  // เก็บ log
  ...
  public ResponseEntity<?> updateWebStatus(@RequestBody WebDto web, @PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "update", "update web status "+web.getWebName());  // เก็บ log
  ...
  public ResponseEntity<?>  updateWeb(@RequestBody WebDto webDto, @PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "update", "update web "+webDto.getWebName());  // เก็บ log
  ...
  public ResponseEntity<?>  deleteWeb(@PathVariable("id") int id){
	  ...
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "delete", "delete web name "+webDb);  // เก็บ log
  ...
  public ResponseEntity<?>  createSchedule(@RequestBody ScheduleDto scheduleDto) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "create", "create schedule "+scheduleDto.getScheduleName());  // เก็บ log
  ...
  public ResponseEntity<?>  readSchedule() {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read schedule");  // เก็บ log
  ...
  public ResponseEntity<?>  readScheduleId(@PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read schedule from id");  // เก็บ log
  ...
  public ResponseEntity<?>  updateSchedule(@RequestBody ScheduleDto scheduleDto, @PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "update", "update schedule "+scheduleDto.getScheduleName());  // เก็บ log
  ...
  public ResponseEntity<?>  deleteSchedule(@PathVariable("id") int id){
	  ...
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "delete", "delete schedule name "+scheduleDb);  // เก็บ log
  ...
  public ResponseEntity<?>  createSwitchDatabase(@RequestBody SwitchDatabaseDto switchDatabaseDto) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "create", "create switch-database "+switchDatabaseDto.getDatabaseName());  // เก็บ log
  ...
  public ResponseEntity<?>  readSwitchDatabase() {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read switch-database");  // เก็บ log
  ...
  public ResponseEntity<?>  readSwitchDatabaseId(@PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "read", "read switch-database from id");  // เก็บ log
  ...
  public ResponseEntity<?> updateSwitchDatabaseStatus(@RequestBody SwitchDatabaseDto switchDatabaseDto, @PathVariable("id") int id) {
	  ...
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "update", "update switch-database-status "+swDb);  // เก็บ log
  ...
  public ResponseEntity<?>  updateSwitchDatabase(@RequestBody SwitchDatabaseDto switchDatabaseDto, @PathVariable("id") int id) {
	  log.createLog(dateTime.timestamp(), this.usernameFromLogin, "update", "update switch-database "+switchDatabaseDto.getDatabaseName());  // เก็บ log
